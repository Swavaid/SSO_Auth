...
public class main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("群众元素大小："+Setup.G_generator.getLengthInBytes());
        System.out.println("私钥的长度："+Setup.ca.CA_sk[0].getLengthInBytes());
        System.out.println("公钥Y的长度："+Setup.ca.CA_pk_X.getLengthInBytes());
        System.out.println("公钥Z的长度："+Setup.ca.CA_pk_Z[0][0].getLengthInBytes());
        System.out.println("群中元素："+Setup.G_generator.toString());
