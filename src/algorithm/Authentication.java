...
public class Authentication {
    ...
    public static Element[] authentication_1() throws Exception {
        ...
        System.out.println("BLS签名的长度："+Sig_1.getLengthInBytes());
...
//        long ca_login_0 = System.nanoTime();
    ...
    public static void authentication_2(Element[] m_s) throws Exception {
        ...
        System.out.println("部分1："+cert_ss_ss.Sig[0].getLengthInBytes());
        System.out.println("部分2："+cert_ss_ss.Sig[1].getLengthInBytes());
        System.out.println("部分3："+cert_ss_ss.Sig[2].getLengthInBytes());
        System.out.println("部分4："+cert_ss_ss.Sig[3].getLengthInBytes());
