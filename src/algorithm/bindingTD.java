...
public class bindingTD {
    ...
    public static void bindingTD() throws Exception {
        ...
        cert_td_TD.td_ID = new SmartDevice().TD_ID;
        cert_td_TD.ca_ID = new CA().Ca_ID;
        ...
        System.out.println("cert_td中的内容："+cert_td_TD);

        System.out.println("cert_td中的内容："+cert_td_TD.serial_2);
        System.out.println("cert_td中的内容："+cert_td_TD.validity_2);
        System.out.println("cert_td中的内容："+cert_td_TD.inject);
        System.out.println("cert_td中的内容："+cert_td_TD.hash_cert);
        System.out.println("cert_td中的内容："+cert_td_TD.hash_inject);
        System.out.println("cert_td中的内容："+cert_td_TD.td_ID);
        System.out.println("cert_td中的内容："+cert_td_TD.ca_ID);

        System.out.println("cert_td中的时间的大小："+cert_td_TD.validity_2.getBytes(StandardCharsets.UTF_8).length);
